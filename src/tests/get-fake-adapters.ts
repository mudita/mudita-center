...
import createFakePurePhoneDisconnectAdapter from "Backend/adapters/pure-phone-disconnect/pure-phone-disconnect-service-fake.adapter"
...
const getFakeAdapters = (): Adapters => ({
  ...
  pureDisconnectService: createFakePurePhoneDisconnectAdapter(),
})
