...
const messagesExistingBackup = defineMessages({
...
const messagesNewBackup = defineMessages({
  cancel: { id: "view.generic.button.cancel" },
  title: {
    id: "view.name.overview.backup.createBackupModal.title",
  },
  body: {
    id: "view.name.overview.backup.createNewBackupModal.body",
  },
})
...
export const BackupStartModal: FunctionComponent<BackupStartModalProps> = ({
  ...
  const messages = fileSize && date ? messagesExistingBackup : messagesNewBackup
