export enum TetheringTestIds {
  ...
  DisabledSecondNotification = "tethering-disabled-second-notification",
  DisabledThirdNotification = "tethering-disabled-third-notification",
  DisabledGotoButton = "tethering-disabled-goto-button",
}
