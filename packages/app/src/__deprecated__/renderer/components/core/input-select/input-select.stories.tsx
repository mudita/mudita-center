...
import { isItemValueMatching } from "App/__deprecated__/renderer/components/core/utils/is-item-matching"
...
export default {
  title: "Components|Core/InputSelect",
}
  ...
  <>
    <StoryContainer title="Themes" customStyle={storyContainerStyles}>
      ...
      <Story title="Condensed (outlined)">
        <InputSelect items={basicItems} condensed outlined label="Fruit type" />
      </Story>
    </StoryContainer>
