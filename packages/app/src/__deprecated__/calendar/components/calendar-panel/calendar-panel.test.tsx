...
import { InputSelectTestIds } from "App/__deprecated__/renderer/components/core/input-select/input-select.component"
...
test("synchronising is performed after clicking button", () => {
  ...
  const synchroniseButton = getByText(
    "[value] module.calendar.panelSynchroniseButton"
  )
...
test("add event is performed after clicking button", () => {
  ...
  const addEventButton = getByText(
    "[value] module.calendar.panelAddEventButton"
  )
