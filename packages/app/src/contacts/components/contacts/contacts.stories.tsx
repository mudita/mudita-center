...
export const ContactDetailsExisting = () => (
  <ContactDetails
...
ContactDetailsExisting.story = {
  name: "Contact details - Existing - No search results",
}
...
export const ContactDetailsEdit = () => (
  <ContactEdit
    speedDialChosenList={speedDialChosenList}
    contact={singleContact()}
...
ContactDetailsNew.story = {
  name: "Contact details - New",
}
