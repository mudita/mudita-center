...
test("apple button calls right function", () => {
  ...
  getByText("[value] view.name.contacts.appleButtonText").click()
...
test("google button calls right function", () => {
  ...
  getByText("[value] view.name.contacts.googleButtonText").click()
...
test("manual import button calls right function", () => {
  ...
  getByText("[value] view.name.contacts.manualImportText").click()
...
test("outlook button calls right function", () => {
  ...
  getByText("[value] view.name.contacts.outlookButtonText").click()
