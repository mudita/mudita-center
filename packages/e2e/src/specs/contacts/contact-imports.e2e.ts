...
describe("import vcf", () => {
  ...
  it("Should import contacts from vcf file", async () => {
    ...
    const modalContactsImportButton = modalContactsPage.buttonImport
    await modalContactsImportButton.waitForDisplayed()
    await modalContactsImportButton.click()
    ...
    const okButton = modalContactsPage.buttonOK
