...
const messages = defineMessages({
  title: {
    id: "general.usbAccess.grantedModal.title",
  },
  description: {
    id: "general.usbAccess.grantedModal.description",
  },
  buttonText: {
    id: "general.usbAccess.grantedModal.buttonText",
  },
})
...
export const UsbAccessGrantedModal: FunctionComponent<Props> = ({
  opened,
  onClose,
  onAction,
}) => {
