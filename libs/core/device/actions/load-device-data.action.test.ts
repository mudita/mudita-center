...
import { ConnectionState, DeviceError } from "Core/device/constants"
import { loadDeviceData, setExternalUsageDevice } from "Core/device/actions"
...
jest.mock("Core/metadata/requests/set-value.request")
jest.mock("Core/analytic-data-tracker/requests/track-unique.request")
jest.mock("Core/device-info/requests")
jest.mock("Core/device/requests/external-usage-device.request")
jest.mock(
  "Core/analytic-data-tracker/requests/set-external-usage-device.request"
)
