...
import * as CreateClientModule from "Core/__deprecated__/api/mudita-center-server/create-client"
import { getUpdatedNews } from "Core/__deprecated__/main/functions/register-news-listener/get-updated-news"
import { generateMockedNewsResponse } from "Core/__deprecated__/main/functions/register-news-listener/__mocks__/generate-mocked-news-response"
import logger from "Core/__deprecated__/main/utils/logger"
import * as normalizeContentfulDataModule from "Core/news/helpers/normalize-contentful-data/normalize-contentful-data.helper"
