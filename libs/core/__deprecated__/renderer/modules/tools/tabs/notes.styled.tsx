...
import BaseSelectionManager from "Core/__deprecated__/renderer/components/core/selection-manager/selection-manager.component"
import BaseTable, {
  Row as BaseRow,
  Col,
  Sidebar,
...
import { FiltersWrapper as FiltersWrapperBase } from "Core/__deprecated__/renderer/components/rest/messages/threads-table.component"
import {
  textColor,
  transitionTime,
