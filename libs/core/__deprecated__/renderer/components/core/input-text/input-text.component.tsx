...
import {
  ...
  TextArea,
  InputPasscode,
} from "Core/__deprecated__/renderer/components/core/input-text/input-text.elements"
import {
  InputComponentProps,
  InputPasscodeProps,
  TextareaProps,
  InputProps,
} from "Core/__deprecated__/renderer/components/core/input-text/input-text.interface"
