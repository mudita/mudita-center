...
import { Image as ImageInterface } from "Core/__deprecated__/renderer/interfaces/image.interface"
import Arrow from "Core/__deprecated__/renderer/svg/arrow.svg"
...
import Delete from "Core/__deprecated__/renderer/svg/delete.svg"
import FilesManager from "Core/__deprecated__/renderer/svg/files-manager.svg"
import HighBattery from "Core/__deprecated__/renderer/svg/battery-high.svg"
import HighRange from "Core/__deprecated__/renderer/svg/signal-high-range.svg"
import LowBattery from "Core/__deprecated__/renderer/svg/battery-low.svg"
import LowRange from "Core/__deprecated__/renderer/svg/low-range.svg"
import Magnifier from "Core/__deprecated__/renderer/svg/magnifier.svg"
import Calendar from "Core/__deprecated__/renderer/svg/menu-calendar.svg"
import MediumBattery from "Core/__deprecated__/renderer/svg/battery-medium.svg"
...
import MuditaLogoVertical from "Core/__deprecated__/renderer/svg/mudita-logo-vertical.svg"
import NoBattery from "Core/__deprecated__/renderer/svg/no-battery.svg"
import NoRange from "Core/__deprecated__/renderer/svg/signal-no-range.svg"
import Refresh from "Core/__deprecated__/renderer/svg/refresh.svg"
import Send from "Core/__deprecated__/renderer/svg/send.svg"
import Sim from "Core/__deprecated__/renderer/svg/sim.svg"
import Template from "Core/__deprecated__/renderer/svg/template.svg"
import Upload from "Core/__deprecated__/renderer/svg/upload.svg"
import UploadDark from "Core/__deprecated__/renderer/svg/upload-dark.svg"
import Download from "Core/__deprecated__/renderer/svg/download.svg"
import DownloadWhite from "Core/__deprecated__/renderer/svg/download-white.svg"
import Calls from "Core/__deprecated__/renderer/svg/phone.svg"
import Connection from "Core/__deprecated__/renderer/svg/connection.svg"
import Contact from "Core/__deprecated__/renderer/svg/contact.svg"
import NewContact from "Core/__deprecated__/renderer/svg/new-contact.svg"
...
import VoiceRecorder from "Core/__deprecated__/renderer/svg/voice-recorder.svg"
import VeryHighBattery from "Core/__deprecated__/renderer/svg/battery-full.svg"
import Pure from "Core/__deprecated__/renderer/svg/pure.svg"
import Fail from "Core/__deprecated__/renderer/svg/fail.svg"
import FailRed from "Core/__deprecated__/renderer/svg/fail-red.svg"
import VeryHighRange from "Core/__deprecated__/renderer/svg/signal-very-high-range.svg"
import VeryLowBattery from "Core/__deprecated__/renderer/svg/battery-very-low.svg"
import Info from "Core/__deprecated__/renderer/svg/info.svg"
import More from "Core/__deprecated__/renderer/svg/more.svg"
import Blocked from "Core/__deprecated__/renderer/svg/blocked.svg"
import Forward from "Core/__deprecated__/renderer/svg/forward.svg"
import Edit from "Core/__deprecated__/renderer/svg/edit.svg"
import Favourites from "Core/__deprecated__/renderer/svg/favourites.svg"
import Ice from "Core/__deprecated__/renderer/svg/ice.svg"
import ArrowDown from "Core/__deprecated__/renderer/svg/arrow-down.svg"
import ArrowDownWhite from "Core/__deprecated__/renderer/svg/arrow-down-white.svg"
import DeleteBig from "Core/__deprecated__/renderer/svg/delete-big.svg"
import Attachment from "Core/__deprecated__/renderer/svg/attachment.svg"
import Remove from "Core/__deprecated__/renderer/svg/remove.svg"
import SendButton from "Core/__deprecated__/renderer/svg/send-button.svg"
import MenuContacts from "Core/__deprecated__/renderer/svg/menu-contacts.svg"
import Backup from "Core/__deprecated__/renderer/svg/backup.svg"
import Tooltip from "Core/__deprecated__/renderer/svg/tooltip.svg"
import TetheringStatus from "Core/__deprecated__/renderer/svg/tethering-status.svg"
import Templates from "Core/__deprecated__/renderer/svg/templates.svg"
import MissedCall from "Core/__deprecated__/renderer/svg/missed-call.svg"
import ConferenceCall from "Core/__deprecated__/renderer/svg/conference-call.svg"
import IncomingCall from "Core/__deprecated__/renderer/svg/incoming-call.svg"
import OutgoingCall from "Core/__deprecated__/renderer/svg/outgoing-call.svg"
import AppleLogo from "Core/__deprecated__/renderer/svg/apple.svg"
import GoogleLogo from "Core/__deprecated__/renderer/svg/google.svg"
import SynchronizeContacts from "Core/__deprecated__/renderer/svg/synchronize-contacts.svg"
import MusicGrey from "Core/__deprecated__/renderer/svg/music-grey.svg"
import VoiceRecorderGrey from "Core/__deprecated__/renderer/svg/voice-recorder-gray.svg"
import FullBattery from "Core/__deprecated__/renderer/svg/full-battery.svg"
import VeryLowRange from "Core/__deprecated__/renderer/svg/signal-very-low-range.svg"
import VeryHighRangeWithRoaming from "Core/__deprecated__/renderer/svg/very-high-range-roaming.svg"
import HighRangeWithRoaming from "Core/__deprecated__/renderer/svg/high-range-roaming.svg"
import MediumRangeWithRoaming from "Core/__deprecated__/renderer/svg/medium-range-roaming.svg"
import LowRangeWithRoaming from "Core/__deprecated__/renderer/svg/low-range-roaming.svg"
import VeryLowRangeWithRoaming from "Core/__deprecated__/renderer/svg/very-low-range-roaming.svg"
import CalendarIcon from "Core/__deprecated__/renderer/svg/calendar.svg"
import ThinCheck from "Core/__deprecated__/renderer/svg/thin-check.svg"
import LongArrow from "Core/__deprecated__/renderer/svg/long-arrow.svg"
import MarkAsRead from "Core/__deprecated__/renderer/svg/mark-as-read.svg"
import RecoveryBackup from "Core/__deprecated__/renderer/svg/recovery-backup.svg"
import RebootOs from "Core/__deprecated__/renderer/svg/reboot-os.svg"
import FactoryReset from "Core/__deprecated__/renderer/svg/factory-reset.svg"
import MuditaFlower from "Core/__deprecated__/renderer/svg/mudita-flower.svg"
import MuditaDarkLogo from "Core/__deprecated__/renderer/svg/mudita-dark-logo.svg"
import ContactGoogle from "Core/__deprecated__/renderer/svg/contact-google.svg"
import Manage from "Core/__deprecated__/renderer/svg/manage.svg"
import MuditaLogoBg from "Core/__deprecated__/renderer/svg/muditalogo-bg.svg"
import Outlook from "Core/__deprecated__/renderer/svg/outlook.svg"
import ContactFilled from "Core/__deprecated__/renderer/svg/contact-filled.svg"
import ThinFail from "Core/__deprecated__/renderer/svg/thin-fail.svg"
import Support from "Core/__deprecated__/renderer/svg/support.svg"
import Visible from "Core/__deprecated__/renderer/svg/password-show.svg"
import Hidden from "Core/__deprecated__/renderer/svg/password-hide.svg"
import Cloud from "Core/__deprecated__/renderer/svg/cloud.svg"
import Warning from "Core/__deprecated__/renderer/svg/warning.svg"
