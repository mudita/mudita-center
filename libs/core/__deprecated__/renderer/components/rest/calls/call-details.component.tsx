...
import { CallsTableTestIds } from "Core/__deprecated__/renderer/components/rest/calls/calls-table.enum"
import {
  CallDescription,
  ContactName,
  NameIcon,
} from "Core/__deprecated__/renderer/components/rest/calls/calls-table.styled"
import {
  AdditionalInfo,
  ButtonWrapper,
  CallWrapper,
} from "Core/__deprecated__/renderer/components/rest/calls/call-details.styled"
import { Details } from "Core/__deprecated__/renderer/components/rest/calls/call-details.types"
import { phoneActions } from "Core/contacts/components/contact-details/contact-details.component"
