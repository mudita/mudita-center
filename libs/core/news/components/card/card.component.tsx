...
import {
  ...
  CardImage,
  CardContent,
} from "Core/news/components/card/card.styled"
import CommunityCommentsCount from "Core/news/components/community-comments-count/community-comments-count.component"
import Text, {
  TextDisplayStyle,
