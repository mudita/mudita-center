...
import { downloadCrashDump } from "Core/crash-dump/actions/download-crash-dump.action"
...
jest.mock("Core/crash-dump/actions/send-crash-dump-data.action", () => ({
  sendCrashDumpData: () => jest.fn(),
}))
jest.mock("Core/crash-dump/requests/download-crash-dump.request")
