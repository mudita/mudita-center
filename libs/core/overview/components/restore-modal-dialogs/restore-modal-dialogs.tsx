...
import { ModalDialog, ModalMainText } from "Core/ui/components/modal-dialog"
...
export const InvalidBackupPasswordModal: FunctionComponent<
  InvalidBackupPasswordModalProps
