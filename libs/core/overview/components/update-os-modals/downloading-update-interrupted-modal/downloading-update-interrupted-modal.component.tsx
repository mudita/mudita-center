...
import { DownloadingUpdateInterruptedModalProps } from "Core/overview/components/update-os-modals/downloading-update-interrupted-modal/downloading-update-interrupted-modal.interface"
