...
import { DownloadingUpdateModalProps } from "Core/overview/components/update-os-modals/downloading-update-modal/downloading-update-modal.interface"
import {
  DownloadBar,
  DownloadProgressText,
  Pergentage,
  Submessage,
} from "Core/overview/components/update-os-modals/downloading-update-modal/downloading-update-modal.styled"
