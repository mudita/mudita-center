...
import { initialState as update } from "Core/update/reducers"
import { initialState as device } from "Core/device/reducers/device.reducer"
...
export function renderHookWithProviders<Result, Props>(
  ...
  store: MockStore<unknown, AnyAction> | undefined
} {
  return {
    store,
    ...renderHook(render, {
