...
import { SpeedDialProps } from "Core/contacts/components/speed-dial-modal/speed-dial-modal.container"
import {
  ListItem,
  upperDropdownListStyles,
} from "Core/__deprecated__/renderer/components/core/list/list.component"
import SearchableText from "Core/__deprecated__/renderer/components/core/searchable-text/searchable-text.component"
import { Contact, ContactID } from "Core/contacts/reducers/contacts.interface"
...
const messages = defineMessages({
  title: { id: "module.contacts.speedDialTitle" },
  saveButton: { id: "module.contacts.speedDialSaveButton" },
  cancelButton: { id: "module.contacts.speedDialCancelButton" },
  speedDialLabel: {
    id: "module.contacts.speedDialSpeedDialLabel",
  },
  contactLabel: { id: "module.contacts.speedDialContactLabel" },
  none: {
