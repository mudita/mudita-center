...
import { ContactListTestIdsEnum } from "Core/contacts/components/contact-list/contact-list-test-ids.enum"
import { ContactListProps } from "Core/contacts/components/contact-list/contact-list.component.interface"
import { SelectableContacts } from "Core/contacts/components/contact-list/contact-list.styled"
import { VirtualizedContactList } from "Core/contacts/components/virtualized-contact-list"
import {
  ContactCategory,
  ResultState,
