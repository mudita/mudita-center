...
import {
  ...
  nameValidator,
  addressValidator,
} from "Core/__deprecated__/renderer/utils/form-validators"
...
import {
  ...
  Form,
  Input,
} from "Core/contacts/components/contact-edit/contact-edit.styled"
import { ContactPanelTestIdsEnum } from "Core/contacts/components/contact-panel/contact-panel-test-ids.enum"
import { ContactEditTestIdsEnum } from "Core/contacts/components/contact-edit/contact-edit-test-ids.enum"
import { FormError } from "Core/contacts/components/contacts/contacts.interface"
