...
import {
  pendingAction,
  rejectedAction,
} from "Core/__deprecated__/renderer/store/helpers/action.helper"
import createMockStore from "redux-mock-store"
import thunk from "redux-thunk"

jest.mock("Core/data-sync/requests/index-all.request.ts")
jest.mock("Core/data-sync/actions/read-all-indexes.action")
