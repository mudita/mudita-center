...
import {
  ...
  toggleItem,
  resetAllItems,
} from "Core/templates/actions/select-items.action"
import { initialState } from "Core/templates/reducers/template.reducer"
import { TemplatesEvent } from "Core/templates/constants"
