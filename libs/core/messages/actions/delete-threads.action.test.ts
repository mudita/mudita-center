...
import { deleteThreads } from "Core/messages/actions/delete-threads.action"
import {
  RequestResponse,
  RequestResponseStatus,
} from "Core/core/types/request-response.interface"
import { CreateMessageDataResponse } from "Core/messages/services"
import { deleteThreadsRequest } from "Core/messages/requests"
import { testError } from "Core/__deprecated__/renderer/store/constants"
import { Message } from "Core/messages/dto"
import { MessagesEvent, MessageType } from "Core/messages/constants"
import { AppError } from "Core/core/errors"

jest.mock("Core/messages/requests/delete-threads.request")
