...
import {
  Textarea,
  TextareaWrapper,
} from "Core/messages/components/thread-details.styled"
import { ThreadDetailsTextAreaTestIds } from "Core/messages/components/thread-details-text-area-tests-ids"
import { IconBackgroundWithTooltip } from "Core/__deprecated__/renderer/components/core/icon-button-with-tooltip/icon-background-with-tooltip.component"
