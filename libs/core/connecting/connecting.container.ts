...
import Connecting from "Core/connecting/components/connecting.component"
import { State } from "Core/core/constants"
import { updateAllIndexes } from "Core/data-sync/actions/update-all-indexes.action"
import { getUnlockStatus, unlockDevice } from "Core/device"
import { getLeftTimeSelector } from "Core/device/selectors/get-left-time.selector"
import { noModalsShowSelector } from "Core/modals-manager/selectors/no-modals-show.selector"
import {
  ReduxRootState,
  RootState,
  TmpDispatch,
