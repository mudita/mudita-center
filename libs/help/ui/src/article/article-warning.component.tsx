...
import { HelpArticle, HelpTestId } from "help/models"

const messages = defineMessages({
  warning: {
    id: "page.article.warning",
  },
})

interface ArticleWarningProps {
  article: HelpArticle | undefined
}

export const ArticleWarning: FunctionComponent<ArticleWarningProps> = ({
  article,
}) => {
  const intl = useIntl()
