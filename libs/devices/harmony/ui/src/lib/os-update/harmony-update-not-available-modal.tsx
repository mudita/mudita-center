...
const messages = defineMessages({
  title: {
    id: "harmony.overview.os.update.modal.notAvailable.title",
  },
  description: {
    id: "harmony.overview.os.update.modal.notAvailable.description",
  },
  closeButton: {
    id: "harmony.overview.os.update.modal.notAvailable.closeButton",
  },
})
...
export const HarmonyUpdateNotAvailableModal: FunctionComponent<Props> = ({
  opened,
  currentVersion,
  onClose,
}) => {
