...
export const recoveryModeTerminalSetupStepList: Messages[] = [
  ...
  McHarmonyMscRecoveryModeMessages.recoveryModeTerminalSetupModalStep2,
  McHarmonyMscRecoveryModeMessages.recoveryModeTerminalSetupModalStep3,
  McHarmonyMscRecoveryModeMessages.recoveryModeTerminalSetupModalStep4,
]
