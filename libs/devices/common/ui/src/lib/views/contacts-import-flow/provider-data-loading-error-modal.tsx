...
const messages = defineMessages({
  title: {
    id: "apiDevice.contacts.import.providerDataLoadingErrorModal.title",
  },
  description: {
    id: "apiDevice.contacts.import.providerDataLoadingErrorModal.description",
  },
  closeButtonText: {
...
export const ProviderDataLoadingErrorModal: FunctionComponent<Props> = ({
  opened,
  onClose,
}) => {
  return (
