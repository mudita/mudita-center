...
const messages = defineMessages({
  title: {
    id: "apiDevice.contacts.import.cancelledModal.title",
  },
  description: {
    id: "apiDevice.contacts.import.cancelledModal.description",
  },
  closeButtonText: {
...
export const ImportCancelledModal: FunctionComponent<Props> = ({
  opened,
  onClose,
}) => {
  return (
