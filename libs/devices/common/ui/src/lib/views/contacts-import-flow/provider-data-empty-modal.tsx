...
const messages = defineMessages({
  title: {
    id: "apiDevice.contacts.import.providerDataEmptyModal.title",
  },
  description: {
    id: "apiDevice.contacts.import.providerDataEmptyModal.description",
  },
  closeButtonText: {
...
export const ProviderDataEmptyModal: FunctionComponent<Props> = ({
  opened,
  onClose,
}) => {
  return (
