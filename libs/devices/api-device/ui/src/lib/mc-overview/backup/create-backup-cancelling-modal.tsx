...
const messages = defineMessages({
  title: {
    id: "apiDevice.backup.cancellingModal.title",
  },
  description: {
    id: "apiDevice.backup.cancellingModal.description",
  },
  backButtonLabel: {
    id: "general.app.backButton.text",
  },
  confirmButtonLabel: {
    id: "apiDevice.backup.cancellingModal.confirmButton",
  },
})
...
export const CreateBackupCancellingModal: FunctionComponent<Props> = ({
  opened,
  onBack,
  onConfirm,
}) => {
