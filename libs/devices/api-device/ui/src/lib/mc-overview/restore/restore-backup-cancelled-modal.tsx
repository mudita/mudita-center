...
const messages = defineMessages({
  title: {
    id: "apiDevice.restore.cancelledModal.title",
  },
  description: {
    id: "apiDevice.restore.cancelledModal.description",
  },
  closeButtonLabel: {
...
export const RestoreBackupCancelledModal: FunctionComponent<Props> = ({
  opened,
  onClose,
}) => {
  return (
