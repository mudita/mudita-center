...
interface TextConfig {
  $color?: NonNullable<ParagraphConfig>["color"]
  $textTransform?: NonNullable<ParagraphConfig>["textTransform"]
}

const commonStyles = css<TextConfig>`
...
export const P1 = styled.p<TextConfig>`
  &,
  ${Content} p {
...
export const P2 = styled.p<TextConfig>`
...
export const P3 = styled.p<TextConfig>`
...
export const P4 = styled.p<TextConfig>`
...
export const P5 = styled.p<TextConfig>`
  ${commonStyles};
