...
export enum ActionName {
  ...
  SetLastOutboxData = "generic-views/set-last-outbox-data",
  ...
  SetDataTransferPostProcessingProgress = "generic-data-transfer/set-data-transfer-post-processing-progress",
