...
This project contains source code and supporting files for a serverless application that you download data from Contentful. Its purpose is to hide any additional envs from user. The only env that user has to have in order to download data from Contentful is lambdas URL. It includes the following files and folders:
...
```bash
aws cloudformation delete-stack --stack-name cms
```
