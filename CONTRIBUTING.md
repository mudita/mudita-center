...
- make sure you're using the latest Mudita Center release when spotting the bug.
...
Please refer to the [Development workflow article](#./doc/development_workflow.md) to learn how to submit code and documentation changes to the Mudita Center repository.